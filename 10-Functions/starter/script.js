...
poll.displayResults.call(testData2, 'array');
 */
...
(function () {
  ...
  // Explanation, the color is changed because selector function call is created inside of the IIFE, hence any function created inside of an Execution context has access to the variable environment of that execution context
