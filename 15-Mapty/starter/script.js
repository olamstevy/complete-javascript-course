...
class Workout {
  ...
  _setDescription() {
    ...
    } ${this.date.getDate()}, at ${this.date
      .getHours()
      .toString()
      .padStart(2, '0')}:00`;
  }
...
class App {
  ...
  _editWorkout(e) {
    ...
    const workoutEl = workoutEditEl.closest('.workout');
    ...
    setTimeout(() => (this.#mapEvent.latlng = { lat, lng }), 1000);

    this.#editWorkoutState = true;
  ...
  _renderWorkout(workout) {
    ...
    html += `
    <div class="workout__details workout__edit" style="width: fit-content;">
      <span class="workout__icon">📝</span>
    </div>
    </li>`;
...
Abilitu to delete all workouts
Ability to sort workouts by a certain field (e.g. distance)
Re-build Running and Cycling objects coming from Local Storage (solve click())
